...
void ngDataSetUp(int *groupnr, double *data, int *vars, int *modes, int *indReal, int *lengths, int *xm, int *printlevel);

void multiCovSetUp(int *ngroups, int *printlevel);
void ngCovSetUp(int *groupnr, double *data, int *vars, int *modes, int *indReal, int *lengths, int *xm, int *printlevel);
